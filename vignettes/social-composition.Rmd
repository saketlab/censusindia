...
output:
  rmarkdown::html_vignette:
    self_contained: true
vignette: >
  %\VignetteIndexEntry{Social composition}
...
Each district has a different mix of Scheduled Caste, Scheduled Tribe, and general population. Ternary plots show these three-way proportions at a glance.

```{r composition, fig.height=8, fig.width=10}
...
```{r regional, fig.height=10, fig.width=12}
...
```{r sc-distribution, fig.height=12}
...
```{r st-distribution, fig.height=12}
...
```{r diversity-composition, fig.height=6, fig.width=10}
