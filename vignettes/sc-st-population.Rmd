...
Scheduled Castes (SC) and Scheduled Tribes (ST) are constitutionally recognized groups in India. SC populations concentrate in the Indo-Gangetic plain; ST populations cluster along the central tribal belt, the northeast, and the Western Ghats.
...
A bivariate choropleth shows both SC and ST percentages simultaneously. One axis represents SC concentration, the other ST concentration.
